...
class _$CartItemModelImpl extends _CartItemModel {
  ...
  @override
  String toString() {
    return 'CartItemModel(id: $id, userId: $userId, productId: $productId, productName: $productName, price: $price, imageUrl: $imageUrl, quantity: $quantity, createdAt: $createdAt)';
  }
